...
Camera::Camera(float fov, float aspectRatio, float near_param, float far_param)
{
	this->projection = glm::perspective(glm::radians(fov), aspectRatio, near_param, far_param);
}
